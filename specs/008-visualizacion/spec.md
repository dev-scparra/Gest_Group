...
| VIS-FR-005 | DEBE incluir la anotación fija `G/ker(phi) ≅ Im(phi)` como recordatorio visual del marco algebraico (Sección 7.6 del documento de contexto) — valor pedagógico para la demo ante el profesor, no funcional. |
